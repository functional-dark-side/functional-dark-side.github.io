...
gu <- fread("data/MG_GTDB_DB/mg_gtdb_kept_annotations/GU_annotations.tsv.gz", stringsAsFactors = F, header = T)
...
load("data/GTDB/phylogenetic_analyis/gtdb_bac_r86_plot.Rda")
f1b <- f1
load("data/GTDB/phylogenetic_analyis/gtdb_arc_r86_plot.Rda")
f1a <- f1
...
write.table(lineage_sp_eduf_gu,"data/GTDB/phylogenetic_analyis/Lineage_sp_eDUF_GUs.tsv", col.names = F, row.names = F, quote = F, sep = "\t")
